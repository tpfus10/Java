...
public class Test01 {
	public static void main(String[] args) {
		...
		System.out.println("obj1.hashCode()=" + obj1.hashCode());// 출력이 정수,해시ㅣ
		System.out.println(Integer.toHexString(obj1.hashCode()));//static 메소드
		...
		System.out.println(obj1);// toString() 결과와 같은 이유는 자동적인 타입 캐스팅 때문임 + 객체 식별자 정수(해시)를 hexa로 변경함
