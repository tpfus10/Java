...
public class Test02 {
	...
	public static void main(String[] args) {
		...
		ArrayList lst = new ArrayList(); // 크기가 10인 리스트를 생성(자동으로 Object class를 저장->Object class 객체 10개가 배열로 저장)
		lst.add(s);
		lst.add(ix);
		// int len3 = (lst.get(0)).length();//오류 > lst.get(0).은 Object이기 때문이다.
		...
		for (int i = 0; i < list.size(); i++)
			System.out.print("list.size()를 사용한 출력:: " + list.get(i));//list.get(i)가 핵심 i는 index
		...
		// 480페이지 1번째 문단
		while (iter.hasNext()) {//iter.hasNext() 알아두기 
