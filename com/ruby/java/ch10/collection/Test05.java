...
public class Test05 {
	...
	public static void main(String[] args) {
		...
		list.offer("파리");//리스트 마지막에
		print(4, list);
		list.offerFirst("로마");//리스트 첫 번째에
		print(5, list);
		list.offerLast("베른");//리스트 마지막에
		print(6, list);

		System.out.println("7 : " + list.peek());//리스트 시작
		System.out.println("8 : " + list.peekFirst());//리스트 시작
		System.out.println("9 : " + list.peekLast());//리스트 끝
		...
		LinkedList<String> list3 = new LinkedList<String>(list2);//LinkedList 생성자
		print(27, list3);
