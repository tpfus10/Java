...
public class Test09 {
	...
	public static void main(String[] args) {
		TreeMap<String, String> users = new TreeMap<>();//map이니까 <key, value>
		users.put("728", "김유빈");  
		users.put("924", "김용빈");
		users.put("319", "김푸름");
		users.put("620", "김하늘");
		...
		print("주어진 키값보다 작은 값중에서 가장 큰 엔트리", entry);//700보다 작으면서 가장 가까운 값

		entry = users.higherEntry("620");
		print("주어진 키값보다 큰 값중에서 가장 작은 엔트리", entry);//620보다 크면서 가장 가까운 값
