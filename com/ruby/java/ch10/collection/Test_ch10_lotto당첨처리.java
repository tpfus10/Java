...
public class Test_ch10_lotto당첨처리 {
	...
	public static void lotto_generator(int n) {
		...
		ArrayList<HashSet<HashSet<Integer>>> lotset = new ArrayList<>();
		HashSet<Integer> lotto = null;//복권 1장
		//List<List<Integer>> al = new ArrayList<>();
		/*같은 번호가 없는 난수 생성(마지막은 보너스 번호) [set] [[ArrayList]]
	...
	static void winnerLotto(HashSet<Integer> w, int bn, List<Hashset<Intger>> lotset) {
	...
	static void checkWinner(HashSet<Integer> w, int bn, List<Hashset<Intger>> lotset) {
		...
		case 2:
			...
			break;
		case 3:
			System.out.println("5등 복권 " + lotSet + " 당첨번호:" + w);
			break;
		case 4:
			System.out.println("4등 복권 " + lotSet + " 당첨번호:" + w);
			break;
		case 5:
